        ...
        <div class="col-xs-12 col-md-4 col-md-offset-4">
          ...
          <form id="formulario_registro">
            ...
            <fieldset>
              ...
              <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-user"></i></div>
                <input type="text" class="form-control" name="customer" placeholder="Ingresa tu codigo asociado">
              </div>
              ...
              <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-user"></i></div>
                <input type="text" class="form-control" name="router" placeholder="ingresa el ID de Controlador">
              </div>
