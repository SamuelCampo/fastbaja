  ...
  class Usuario extends Conexion
  {
    ...
    public function login($user, $clave)
    {
      ...
      */
      ...
      $consulta = 'select id, nombre, customer, router, cargo from usuarios where email="'.$user.'" and clave= MD5("'.$clave.'")';
      /*
    ...
    public function registroUsuario($name, $customer, $router, $email, $clave)
    {
      parent::conectar();
      ...
      if($verificarCorreo > 0){
        ...
        parent::query('insert into usuarios(nombre, customer, router, email, clave, cargo) values("'.$name.'", "'.$customer.'", "'.$router.'", "'.$email.'", MD5("'.$clave.'"), 2)');
